...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'contactcarhubb@gmail.com'  # Thay bằng địa chỉ email của bạn
EMAIL_HOST_PASSWORD = 'noqc sbae xymn ymfm'  # Thay bằng mật khẩu ứng dụng bạn đã tạo